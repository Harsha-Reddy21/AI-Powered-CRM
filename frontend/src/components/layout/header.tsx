      ...
      <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-lg relative">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5-5-5h5zm-1.07-1.93A2 2 0 0015 13V9a6 6 0 10-12 0v4a2 2 0 001.07 1.93l1.43.57a1 1 0 00.5 0l1.43-.57z" />
            </svg>
